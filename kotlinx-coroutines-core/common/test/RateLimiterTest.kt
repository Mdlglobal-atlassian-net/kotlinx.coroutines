...
class RateLimiterTest : TestBase() {
    ...
    private fun relinquishSmokeTest(limiter: RateLimiterImplBase, clock: Clock, refillPeriod: Long, tokens: Long) {
        ...
        val hugeReservation = limiter.requestTimeSlot(hugeReservationTime, tokens * k,
            refillPeriod * k)
        assertTrue(hugeReservation >= k + clock.currentTimeNanos && hugeReservation < Long.MAX_VALUE)
        ...
        limiter.relinquishTokens(hugeReservationTime + 2, hugeReservation, tokens * k)
